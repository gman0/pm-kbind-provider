...
// KbindCluster records a single kbind bundle that was generated by the portal.
...
// Cluster-scoped. Multiple KbindCluster objects may exist for the same consumer
...
// KbindClusterStatus is the observed state updated by the KbindClusterReconciler.
...
// KbindClusterList contains a list of KbindCluster.
//
// +kubebuilder:object:root=true
type KbindClusterList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []KbindCluster `json:"items"`
}
